...
- A tiny .NET 6 console application (same as Rust version), to quickly switch to another input source.
- A tiny Rust CLI executable (same as .NET version), to quickly switch to another input source.
